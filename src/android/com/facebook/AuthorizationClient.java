...
class AuthorizationClient implements Serializable {
    ...
    boolean checkInternetPermission() {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            String errorType = context.getString(IntelXDKFacebook.getId("string", "com_facebook_internet_permission_error_title"));
            String errorDescription = context.getString(IntelXDKFacebook.getId("string", "com_facebook_internet_permission_error_message"));
