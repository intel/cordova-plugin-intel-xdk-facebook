...
public class ProfilePictureView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, IntelXDKFacebook.getStyleableIntArray("com_facebook_profile_picture_view"));
        setPresetSize(a.getInt(IntelXDKFacebook.getId("styleable", "com_facebook_profile_picture_view_preset_size"), CUSTOM));
        isCropped = a.getBoolean(IntelXDKFacebook.getId("styleable", "com_facebook_profile_picture_view_is_cropped"), IS_CROPPED_DEFAULT_VALUE);
        a.recycle();
    }
    ...
    private void setBlankProfilePicture() {
        if (customizedDefaultProfilePicture == null) {
          int blankImageResource = isCropped() ?
        		  IntelXDKFacebook.getId("drawable", "com_facebook_profile_picture_blank_square") :
        			  IntelXDKFacebook.getId("drawable", "com_facebook_profile_picture_blank_portrait");
    ...
    private int getPresetSizeInPixels(boolean forcePreset) {
        ...
        switch (presetSizeType) {
            case SMALL:
                dimensionId = IntelXDKFacebook.getId("dimen", "com_facebook_profilepictureview_preset_size_small");
                break;
            case NORMAL:
                dimensionId = IntelXDKFacebook.getId("dimen", "com_facebook_profilepictureview_preset_size_normal");
                break;
            case LARGE:
                dimensionId = IntelXDKFacebook.getId("dimen", "com_facebook_profilepictureview_preset_size_large");
                break;
            case CUSTOM:
                if (!forcePreset) {
