...
public class FriendPickerFragment extends PickerFragment<GraphUser> {
    ...
    public FriendPickerFragment(Bundle args) {
        super(GraphUser.class, IntelXDKFacebook.getId("layout", "com_facebook_friendpickerfragment"), args);
    ...
    public void onInflate(Activity activity, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        TypedArray a = activity.obtainStyledAttributes(attrs, IntelXDKFacebook.getStyleableIntArray("com_facebook_friend_picker_fragment"));

        setMultiSelect(a.getBoolean(IntelXDKFacebook.getId("styleable", "com_facebook_friend_picker_fragment_multi_select"), multiSelect));
    ...
    String getDefaultTitleText() {
        return getString(IntelXDKFacebook.getId("string", "com_facebook_choose_friends"));
    }
