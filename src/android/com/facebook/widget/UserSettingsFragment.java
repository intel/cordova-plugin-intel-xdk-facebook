...
public class UserSettingsFragment extends FacebookFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(IntelXDKFacebook.getId("layout", "com_facebook_usersettingsfragment"), container, false);
        loginButton = (LoginButton) view.findViewById(IntelXDKFacebook.getId("id", "com_facebook_usersettingsfragment_login_button"));
        ...
        connectedStateLabel = (TextView) view.findViewById(IntelXDKFacebook.getId("id", "com_facebook_usersettingsfragment_profile_name"));
        
        // if no background is set for some reason, then default to Facebook blue
        if (view.getBackground() == null) {
            view.setBackgroundColor(getResources().getColor(IntelXDKFacebook.getId("color", "com_facebook_blue")));
        } else {
    ...
    private void updateUI() {
        ...
        if (isSessionOpen()) {
            connectedStateLabel.setTextColor(getResources().getColor(IntelXDKFacebook.getId("color", "com_facebook_usersettingsfragment_connected_text_color")));
            connectedStateLabel.setShadowLayer(1f, 0f, -1f,
                    getResources().getColor(IntelXDKFacebook.getId("color", "com_facebook_usersettingsfragment_connected_shadow_color")));
            ...
            if (user != null) {
                ...
                connectedStateLabel.setText(getResources().getString(
                		IntelXDKFacebook.getId("string", "com_facebook_usersettingsfragment_logged_in")));
                Drawable noProfilePic = getResources().getDrawable(IntelXDKFacebook.getId("drawable", "com_facebook_profile_default_icon"));
                noProfilePic.setBounds(0, 0,
                        getResources().getDimensionPixelSize(IntelXDKFacebook.getId("dimen", "com_facebook_usersettingsfragment_profile_picture_width")),
                        getResources().getDimensionPixelSize(IntelXDKFacebook.getId("dimen", "com_facebook_usersettingsfragment_profile_picture_height")));
                connectedStateLabel.setCompoundDrawables(null, noProfilePic, null, null);
            }
        } else {
            int textColor = getResources().getColor(IntelXDKFacebook.getId("color", "com_facebook_usersettingsfragment_not_connected_text_color"));
            connectedStateLabel.setTextColor(textColor);
            connectedStateLabel.setShadowLayer(0f, 0f, 0f, textColor);
            connectedStateLabel.setText(getResources().getString(
            		IntelXDKFacebook.getId("string", "com_facebook_usersettingsfragment_not_logged_in")));
