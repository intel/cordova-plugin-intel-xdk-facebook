...
import com.intel.xdk.facebook.IntelXDKFacebook;
...
public class LoginButton extends Button {
    ...
    public LoginButton(Context context, AttributeSet attrs) {
        ...
        if (attrs.getStyleAttribute() == 0) {
            ...
            this.setTextColor(getResources().getColor(IntelXDKFacebook.getId("color", "com_facebook_loginview_text_color")));
            this.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    getResources().getDimension(IntelXDKFacebook.getId("dimen", "com_facebook_loginview_text_size")));
            this.setTypeface(Typeface.DEFAULT_BOLD);
            if (isInEditMode()) {
                // cannot use a drawable in edit mode, so setting the background color instead
                // of a background resource.
                this.setBackgroundColor(getResources().getColor(IntelXDKFacebook.getId("color", "com_facebook_blue")));
                // hardcoding in edit mode as getResources().getString() doesn't seem to work in IntelliJ
                loginText = "Log in with Facebook";
            } else {
                this.setBackgroundResource(IntelXDKFacebook.getId("drawable", "com_facebook_button_blue"));
                this.setCompoundDrawablesWithIntrinsicBounds(IntelXDKFacebook.getId("drawable", "com_facebook_inverse_icon"), 0, 0, 0);
                this.setCompoundDrawablePadding(
                        getResources().getDimensionPixelSize(IntelXDKFacebook.getId("dimen", "com_facebook_loginview_compound_drawable_padding")));
                this.setPadding(getResources().getDimensionPixelSize(IntelXDKFacebook.getId("dimen", "com_facebook_loginview_padding_left")),
                        getResources().getDimensionPixelSize(IntelXDKFacebook.getId("dimen", "com_facebook_loginview_padding_top")),
                        getResources().getDimensionPixelSize(IntelXDKFacebook.getId("dimen", "com_facebook_loginview_padding_right")),
                        getResources().getDimensionPixelSize(IntelXDKFacebook.getId("dimen", "com_facebook_loginview_padding_bottom")));
            }
        }
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, IntelXDKFacebook.getStyleableIntArray("com_facebook_login_view"));
        confirmLogout = a.getBoolean(IntelXDKFacebook.getId("styleable", "com_facebook_login_view_confirm_logout"), true);
        fetchUserInfo = a.getBoolean(IntelXDKFacebook.getId("styleable", "com_facebook_login_view_fetch_user_info"), true);
        loginText = a.getString(IntelXDKFacebook.getId("styleable", "com_facebook_login_view_login_text"));
        logoutText = a.getString(IntelXDKFacebook.getId("styleable", "com_facebook_login_view_logout_text"));
        a.recycle();
    }
    ...
    private void setButtonText() {
        if (sessionTracker != null && sessionTracker.getOpenSession() != null) {
            setText((logoutText != null) ? logoutText :
                    getResources().getString(IntelXDKFacebook.getId("string", "com_facebook_loginview_log_out_button")));
        } else {
            setText((loginText != null) ? loginText :
                    getResources().getString(IntelXDKFacebook.getId("string", "com_facebook_loginview_log_in_button")));
        }
    }
        ...
        public void onClick(View v) {
            ...
            if (openSession != null) {
                ...
                if (confirmLogout) {
                    ...
                    String logout = getResources().getString(IntelXDKFacebook.getId("string", "com_facebook_loginview_log_out_action"));
                    String cancel = getResources().getString(IntelXDKFacebook.getId("string", "com_facebook_loginview_cancel_action"));
                    String message;
                    if (user != null && user.getName() != null) {
                        message = String.format(getResources().getString(IntelXDKFacebook.getId("string", "com_facebook_loginview_logged_in_as")), user.getName());
                    } else {
                        message = getResources().getString(IntelXDKFacebook.getId("string", "com_facebook_loginview_logged_in_using_facebook"));
                    }
