...
public class WebDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setMessage(getContext().getString(IntelXDKFacebook.getId("string", "com_facebook_loading")));
    ...
    private void createCrossImage() {
        ...
        Drawable crossDrawable = getContext().getResources().getDrawable(IntelXDKFacebook.getId("drawable", "com_facebook_close"));
