...
class GraphObjectAdapter<T extends GraphObject> extends BaseAdapter implements SectionIndexer {
    ...
    protected View getSectionHeaderView(String sectionHeader, View convertView, ViewGroup parent) {
        ...
        if (result == null) {
            result = (TextView) inflater.inflate(IntelXDKFacebook.getId("layout", "com_facebook_picker_list_section_header"), null);
        }
    ...
    private View getActivityCircleView(View convertView, ViewGroup parent) {
        ...
        if (result == null) {
            result = inflater.inflate(IntelXDKFacebook.getId("layout", "com_facebook_picker_activity_circle_row"), null);
        }
        ProgressBar activityCircle = (ProgressBar) result.findViewById(IntelXDKFacebook.getId("id", "com_facebook_picker_row_activity_circle"));
    ...
    protected int getGraphObjectRowLayoutId(T graphObject) {
        return IntelXDKFacebook.getId("layout", "com_facebook_picker_list_row");
    }

    protected int getDefaultPicture() {
        return IntelXDKFacebook.getId("drawable", "com_facebook_profile_default_icon");
    }

    protected View createGraphObjectView(T graphObject) {
        View result = inflater.inflate(getGraphObjectRowLayoutId(graphObject), null);

        ViewStub checkboxStub = (ViewStub) result.findViewById(IntelXDKFacebook.getId("id", "com_facebook_picker_checkbox_stub"));
        ...
        ViewStub profilePicStub = (ViewStub) result.findViewById(IntelXDKFacebook.getId("id", "com_facebook_picker_profile_pic_stub"));
        if (!getShowPicture()) {
    ...
    protected void populateGraphObjectView(View view, T graphObject) {
        ...
        TextView titleView = (TextView) view.findViewById(IntelXDKFacebook.getId("id", "com_facebook_picker_title"));
        if (titleView != null) {
            titleView.setText(title, TextView.BufferType.SPANNABLE);
        }

        CharSequence subtitle = getSubTitleOfGraphObject(graphObject);
        TextView subtitleView = (TextView) view.findViewById(IntelXDKFacebook.getId("id", "picker_subtitle"));
        ...
        if (getShowCheckbox()) {
            CheckBox checkBox = (CheckBox) view.findViewById(IntelXDKFacebook.getId("id", "com_facebook_picker_checkbox"));
        ...
        if (getShowPicture()) {
            ...
            if (pictureURI != null) {
                ImageView profilePic = (ImageView) view.findViewById(IntelXDKFacebook.getId("id", "com_facebook_picker_image"));
    ...
    String getPictureFieldSpecifier() {
        ...
        ImageView picture = (ImageView) view.findViewById(IntelXDKFacebook.getId("id", "com_facebook_picker_image"));
        if (picture == null) {
            return null;
        }
