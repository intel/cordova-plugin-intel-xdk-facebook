...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(IntelXDKFacebook.getId("layout", "com_facebook_login_activity_layout"));
        ...
        authorizationClient.setBackgroundProcessingListener(new AuthorizationClient.BackgroundProcessingListener() {
            ...
            public void onBackgroundProcessingStarted() {
                findViewById(IntelXDKFacebook.getId("id", "com_facebook_login_activity_progress_bar")).setVisibility(View.VISIBLE);
            }

            @Override
            public void onBackgroundProcessingStopped() {
                findViewById(IntelXDKFacebook.getId("id", "com_facebook_login_activity_progress_bar")).setVisibility(View.GONE);
            }
        });
    }
